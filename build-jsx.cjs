...
(function () {
  ...
  var PAGE_LABELS = {
    ...
    lojas: '11 Painel de Lojas',
    risco: '12 Risco & Concentração',
    faturamento_produto: '13 Faturamento por Produto',
    curva_abc: '14 Curva ABC',
    marketing: '15 Marketing ADS',
    hierarquia: '13 Hierarquia ADS',
    detalhado: '14 Detalhado',
    profunda_cliente: '15 Profunda Cliente',
    crm: '16 CRM',
    comercial: '21 Resultados Comerciais',
